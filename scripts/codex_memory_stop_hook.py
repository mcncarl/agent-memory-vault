...
LOG_PATH = Path(os.path.expandvars(os.environ.get("CODEX_MEMORY_CLOSEOUT_LOG", str(CONFIG_ROOT / "logs" / "closeout.jsonl")))).expanduser().resolve()
CLOSEOUT_SCRIPT = REPO_ROOT / "scripts" / "codex_memory_closeout.py"
